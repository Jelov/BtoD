...
# with command line options: Configuration/GenProduction/python/Pythia8_nonprompt_D0pt4p0to10p0_Pthat0_TuneCUETP8M1_5020GeV_cfi_evtgen130.py --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --datatier GEN-SIM --conditions MCRUN2_71_V1 --beamspot Nominal5TeVpp2015Collision --step GEN,SIM --magField 38T_PostLS1
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Pythia8_nonprompt_D0pt4p0to10p0_Pthat0_TuneCUETP8M1_5020GeV_cfi_evtgen130.py nevts:1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Pythia8_nonprompt_D0pt4p0to10p0_Pthat0_TuneCUETP8M1_5020GeV_cfi_evtgen130_py_GEN_SIM.root'),
...
process.D0Daufilter = cms.EDFilter("PythiaMomDauFilter",
    ...
    MomMaxPt = cms.untracked.double(10.0),
