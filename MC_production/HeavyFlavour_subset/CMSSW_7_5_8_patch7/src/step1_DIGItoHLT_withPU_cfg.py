...
# with command line options: step1 --filein file:PbPb_prompt_D0pt2to4_GenSim.root --fileout file:PbPb_prompt_D0pt2to4_step1_DIGItoHLT_withPU.root --mc --eventcontent RAWSIM --pileup_input dbs:/Hydjet_Quenched_MinBias_5020GeV_750/HiFall15-75X_mcRun2_HeavyIon_v1_75X_mcRun2_HeavyIon_v1-v1/GEN-SIM --pileup HiMix --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --conditions 75X_mcRun2_HeavyIon_v14 --step DIGI:pdigi_hi,L1,DIGI2RAW,HLT:HIon --scenario HeavyIons --python_filename step1_DIGItoHLT_withPU_cfg.py --no_exec -n 64
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:PbPb_prompt_D0pt2to4_GenSim.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PbPb_prompt_D0pt2to4_step1_DIGItoHLT_withPU.root'),
