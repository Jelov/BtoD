...
# with command line options: HFAnaGenFrags/DAnaPbPb_HFSubset/python/Pythia8_prompt_D0pt2p0to4p0_Pthat0_TuneCUETP8M1_5020GeV_cfi_evtgen130.py --fileout file:PbPb_prompt_D0pt2to4_GenSim.root --pileup_input dbs:/Hydjet_Quenched_MinBias_5020GeV_750/HiFall15-75X_mcRun2_HeavyIon_v1_75X_mcRun2_HeavyIon_v1-v1/GEN-SIM --mc --eventcontent RAWSIM --pileup HiMixGEN --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions 75X_mcRun2_HeavyIon_v14 --beamspot MatchHI --step GEN,SIM --scenario HeavyIons --python_filename PbPb_prompt_D0pt2to4_GenSim_cfg.py --no_exec -n 2497
...
process.maxEvents = cms.untracked.PSet(
    #input = cms.untracked.int32(2497)
		output = cms.untracked.int32(1500)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('HFAnaGenFrags/DAnaPbPb_HFSubset/python/Pythia8_prompt_D0pt2p0to4p0_Pthat0_TuneCUETP8M1_5020GeV_cfi_evtgen130.py nevts:2497'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PbPb_prompt_D0pt2to4_GenSim.root'),
