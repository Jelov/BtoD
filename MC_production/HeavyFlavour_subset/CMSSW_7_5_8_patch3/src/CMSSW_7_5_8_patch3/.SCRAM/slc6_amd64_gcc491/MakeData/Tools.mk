...
ALL_TOOLS      += blackhat
blackhat_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/blackhat/0.9.9-eccfad/include
...
boost_header_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/boost/1.57.0-eccfad/include
...
boost_python_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/boost/1.57.0-eccfad/include
...
ALL_TOOLS      += bz2lib
bz2lib_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/bz2lib/1.0.5-cms/include
bz2lib_EX_LIB := bz2
...
cascade_headers_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/cascade/2.2.04-eccfad2/include
...
castor_header_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/castor/2.1.13.9-cms/include /afs/cern.ch/cms/slc6_amd64_gcc491/external/castor/2.1.13.9-cms/include/shift
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/cgal/4.2-eccfad/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/charybdis/1.003-eccfad2/include
charybdis_EX_LIB := charybdis
charybdis_EX_USE := root_cxxdefaults f77compiler herwig pythia6

ALL_TOOLS      += classlib
classlib_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/classlib/3.1.3-eccfad/include
...
ALL_TOOLS      += clhep
clhep_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/clhep/2.1.4.1-eccfad/include
clhep_EX_LIB := CLHEP
clhep_EX_USE := root_cxxdefaults

ALL_TOOLS      += clhepheader
clhepheader_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/clhep/2.1.4.1-eccfad/include
clhepheader_EX_USE := root_cxxdefaults

ALL_TOOLS      += cmssw
ALL_SCRAM_PROJECTS += cmssw
cmssw_EX_LIBDIR := /afs/cern.ch/cms/slc6_amd64_gcc491/cms/cmssw/CMSSW_7_5_8/lib/slc6_amd64_gcc491
...
coral_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/cms/coral/CORAL_2_3_21-eccfad9/include/LCG
coral_EX_USE := root_cxxdefaults
coral_ORDER := 98000

ALL_TOOLS      += cppunit
cppunit_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/cppunit/1.12.1-cms/include
cppunit_EX_LIB := cppunit
cppunit_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += curl
curl_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/curl/7.28.0-eccfad/include
curl_EX_LIB := curl
...
ALL_TOOLS      += db4
db4_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/db4/4.4.20-cms/include
db4_EX_LIB := db
...
ALL_TOOLS      += dcap
dcap_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/dcap/2.47.8-eccfad/include
dcap_EX_LIB := dcap
...
ALL_TOOLS      += dpm
dpm_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/dpm/1.8.0.1-cms/include
dpm_EX_LIB := dpm
dpm_EX_LIBDIR := /afs/cern.ch/cms/slc6_amd64_gcc491/external/dpm/1.8.0.1-cms/lib
dpm_EX_USE := root_cxxdefaults

ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/eigen/3.2.2/include
eigen_EX_FLAGS_CPPDEFINES  := -DEIGEN_DONT_PARALLELIZE

ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/evtgen/1.3.0-eccfad4/include
evtgen_EX_LIB := EvtGen EvtGenExternal
evtgen_EX_USE := hepmc pythia8 tauolapp photospp

ALL_TOOLS      += evtgenlhc
evtgenlhc_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/evtgenlhc/9.1-eccfad
evtgenlhc_EX_LIB := evtgenlhc
evtgenlhc_EX_USE := root_cxxdefaults clhep

ALL_TOOLS      += expat
expat_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/expat/2.0.1-cms/include
expat_EX_LIB := expat
expat_EX_USE := root_cxxdefaults

ALL_TOOLS      += fastjet-contrib-archive
fastjet-contrib-archive_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/fastjet-contrib/1.014-odfocd/include
...
fastjet-contrib_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/fastjet-contrib/1.014-odfocd/include
fastjet-contrib_EX_LIB := fastjetcontribfragile

ALL_TOOLS      += fastjet
fastjet_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/fastjet/3.1.0-odfocd/include
fastjet_EX_LIB := fastjetplugins fastjettools siscone siscone_spherical fastjet
fastjet_EX_USE := root_cxxdefaults

ALL_TOOLS      += fftjet
fftjet_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/fftjet/1.5.0-cms/include
fftjet_EX_LIB := fftjet
fftjet_EX_USE := root_cxxdefaults

ALL_TOOLS      += fftw3
fftw3_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/fftw3/3.3.2-cms/include
fftw3_EX_LIB := fftw3
fftw3_EX_USE := root_cxxdefaults

ALL_TOOLS      += file
file_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/file/5.13-cms/include
file_EX_LIB := magic

ALL_TOOLS      += frontier_client
frontier_client_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/frontier_client/2.8.11-eccfad/include
...
ALL_TOOLS      += gdbm
gdbm_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/gdbm/1.10-cms/include
gdbm_EX_LIB := gdbm
...
geant4core_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/geant4/10.00.p03-eccfad2/include/Geant4
...
ALL_TOOLS      += gmp
gmp_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/gmp-static/5.1.3-eccfad/include
gmp_EX_LIB := gmp
gmp_EX_USE := mpfr
...
ALL_TOOLS      += gsl
gsl_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/gsl/1.10-cms/include
gsl_EX_LIB := gsl gslcblas
gsl_EX_USE := root_cxxdefaults

ALL_TOOLS      += hector
hector_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/hector/1.3.4-eccfad7/include
...
hepmc_headers_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/hepmc/2.06.07-eccfad/include
hepmc_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += heppdt
heppdt_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/heppdt/3.03.00-cms/include
heppdt_EX_LIB := HepPDT HepPID
heppdt_EX_USE := root_cxxdefaults

ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/herwig/6.521-eccfad2/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := root_cxxdefaults f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/herwigpp/2.7.1-eccfad2/include
...
ALL_TOOLS      += jemalloc
jemalloc_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/jemalloc/3.5.0-cms/include
...
jimmy_headers_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/jimmy/4.2-eccfad2/include
jimmy_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/ktjet/1.06-eccfad/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/lhapdf/6.1.5-eccfad2/include
lhapdf_EX_LIB := LHAPDF
lhapdf_EX_USE := yaml-cpp root_cxxdefaults

ALL_TOOLS      += libhepml
libhepml_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/libhepml/0.2.1-cms/interface
libhepml_EX_LIB := hepml
libhepml_EX_USE := root_cxxdefaults

ALL_TOOLS      += libjpg
libjpg_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/libjpg/8b-cms/include
libjpg_EX_LIB := jpeg
libjpg_EX_USE := root_cxxdefaults

ALL_TOOLS      += libpng
libpng_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/libpng/1.6.16-eccfad/include
libpng_EX_LIB := png
libpng_EX_USE := root_cxxdefaults zlib

ALL_TOOLS      += libtiff
libtiff_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/libtiff/3.9.4-cms/include
libtiff_EX_LIB := tiff
libtiff_EX_USE := root_cxxdefaults libjpg zlib

ALL_TOOLS      += libungif
libungif_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/libungif/4.1.4-cms/include
libungif_EX_LIB := ungif
libungif_EX_USE := root_cxxdefaults libjpg zlib

ALL_TOOLS      += libuuid
libuuid_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/libuuid/2.22.2-cms/include
libuuid_EX_LIB := uuid
libuuid_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += libxml2
libxml2_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/libxml2/2.7.7-cms/include/libxml2
libxml2_EX_LIB := xml2
libxml2_EX_USE := root_cxxdefaults

ALL_TOOLS      += libxslt
libxslt_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/libxslt/1.1.26/include/libxslt
libxslt_EX_LIB := xslt
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/llvm/3.6-eccfad/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += mcdb
mcdb_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/mcdb/1.0.2-cms/interface
mcdb_EX_LIB := mcdb
mcdb_EX_USE := root_cxxdefaults xerces-c

ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/mctester/1.25.0a-eccfad7/include
mctester_EX_LIB := HEPEvent HepMCEvent MCTester
mctester_EX_USE := root_cxxdefaults root hepmc

ALL_TOOLS      += meschach
meschach_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/meschach/1.2.pCMS1-cms/include
...
ALL_TOOLS      += mpfr
mpfr_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/mpfr-static/3.1.2-eccfad/include
mpfr_EX_LIB := mpfr
...
ALL_TOOLS      += openssl
openssl_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/openssl/0.9.8e__1.0.1-cms/include
openssl_EX_LIB := ssl crypto
openssl_EX_USE := root_cxxdefaults

ALL_TOOLS      += oracle
oracle_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/oracle/11.2.0.3.0__10.2.0.4.0-cms/include
...
ALL_TOOLS      += pacparser
pacparser_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/pacparser/1.3.1-cms/include
pacparser_EX_LIB := pacparser
pacparser_EX_USE := root_cxxdefaults

ALL_TOOLS      += pcre
pcre_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/pcre/7.9__8.33-cms/include
pcre_EX_LIB := pcre
...
photos_headers_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/photos/215.5-cms/include
photos_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += photospp
photospp_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/photospp/3.56-eccfad/include
...
ALL_TOOLS      += protobuf
protobuf_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/protobuf/2.4.1-cms/include
...
pythia6_headers_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/pythia6/426-cms/include
pythia6_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/pythia8/212/include
...
ALL_TOOLS      += python
python_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/python/2.7.6-eccfad/include/python2.7
python_EX_LIB := python2.7
python_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += qd
qd_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/qd/2.3.13-cms/include
qd_EX_LIB := qd_f_main qdmod qd

ALL_TOOLS      += qt
qt_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/qt/4.8.1-cms/include/QtOpenGL /afs/cern.ch/cms/slc6_amd64_gcc491/external/qt/4.8.1-cms/include/QtGui
qt_EX_LIB := QtOpenGL QtGui
qt_EX_USE := root_cxxdefaults qtbase qt3support x11 opengl

ALL_TOOLS      += qt3support
qt3support_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/qt/4.8.1-cms/include/Qt3Support
...
qtdesigner_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/qt/4.8.1-cms/include/QtDesigner
qtdesigner_EX_LIB := QtDesigner
qtdesigner_EX_USE := root_cxxdefaults qtbase qt

ALL_TOOLS      += qtextra
qtextra_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/qt/4.8.1-cms/include/QtScript
qtextra_EX_LIB := QtScript
qtextra_EX_USE := root_cxxdefaults qtbase

ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/rivet/2.2.1-eccfad2/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/lcg/root/6.02.12/include
...
root_interface_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/lcg/root/6.02.12/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/lcg/root/6.02.12/include
...
ALL_TOOLS      += self
self_EX_INCLUDE := /afs/cern.ch/user/c/chengchi/scratch/Project/BtoD/MC_production/HeavyFlavour_subset/CMSSW_7_5_8_patch3/src /afs/cern.ch/user/c/chengchi/scratch/Project/BtoD/MC_production/HeavyFlavour_subset/CMSSW_7_5_8_patch3/include/LCG /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/cmssw-patch/CMSSW_7_5_8_patch3/src /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/cmssw-patch/CMSSW_7_5_8_patch3/include/LCG
self_EX_LIBDIR := /afs/cern.ch/user/c/chengchi/scratch/Project/BtoD/MC_production/HeavyFlavour_subset/CMSSW_7_5_8_patch3/lib/slc6_amd64_gcc491 /afs/cern.ch/user/c/chengchi/scratch/Project/BtoD/MC_production/HeavyFlavour_subset/CMSSW_7_5_8_patch3/external/slc6_amd64_gcc491/lib /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/cmssw-patch/CMSSW_7_5_8_patch3/lib/slc6_amd64_gcc491 /cvmfs/cms.cern.ch/slc6_amd64_gcc491/cms/cmssw-patch/CMSSW_7_5_8_patch3/external/slc6_amd64_gcc491/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/sherpa/2.1.1-eccfad2/include/SHERPA-MC
sherpa_EX_LIB := SherpaMain ToolsMath ToolsOrg
sherpa_EX_USE := root_cxxdefaults hepmc lhapdf qd blackhat fastjet sqlite

ALL_TOOLS      += sigcpp
sigcpp_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/sigcpp/2.2.10-eccfad/include/sigc++-2.0
...
ALL_TOOLS      += sqlite
sqlite_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/sqlite/3.7.17-cms/include
...
tauola_headers_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/tauola/27.121.5-cms/include
tauola_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/tauolapp/1.1.5-eccfad4/include
...
ALL_TOOLS      += tbb
tbb_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/tbb/43_20150316oss/include
tbb_EX_LIB := tbb
...
ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/thepeg/1.9.2p1-eccfad2/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := root_cxxdefaults lhapdf gsl

ALL_TOOLS      += tkonlinesw
tkonlinesw_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/tkonlinesw/2.7.0-cms/include
...
toprex_headers_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/toprex/4.23-cms/include
toprex_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += valgrind
valgrind_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/valgrind/3.10.1-eccfad/include
...
vdt_headers_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/cms/vdt/v0.3.2-eccfad/include
...
ALL_TOOLS      += xerces-c
xerces-c_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/xerces-c/2.8.0-cms/include
xerces-c_EX_LIB := xerces-c
xerces-c_EX_USE := root_cxxdefaults

ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/xrootd/4.0.4-eccfad3/include/xrootd /afs/cern.ch/cms/slc6_amd64_gcc491/external/xrootd/4.0.4-eccfad3/include/xrootd/private
xrootd_EX_LIB := XrdUtils XrdClient
xrootd_EX_USE := root_cxxdefaults

ALL_TOOLS      += xz
xz_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/xz/5.2.1/include
xz_EX_LIB := lzma
xz_EX_USE := root_cxxdefaults

ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/yaml-cpp/0.5.1-eccfad/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/yoda/1.3.1-eccfad/include
yoda_EX_LIB := YODA
yoda_EX_USE := boost

ALL_TOOLS      += zlib
zlib_EX_INCLUDE := /afs/cern.ch/cms/slc6_amd64_gcc491/external/zlib/1.2.8-cms/include
zlib_EX_LIB := z
