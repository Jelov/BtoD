...
# with command line options: step3 --mc --eventcontent AODSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --datatier AODSIM --conditions 75X_mcRun2_HeavyIon_v13 --step RAW2DIGI,L1Reco,RECO --scenario HeavyIons
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step2_prompt_D0pt0to2__DIGI_L1_DIGI2RAW_HLT_PU.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step3_prompt_D0pt0to2_RAW2DIGI_L1Reco_RECO.root'),
