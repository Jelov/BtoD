void projectPPMBMC()
{
  ...
  tMCP->Draw("DsvpvDistance*sin(Dalpha):Dmass:Dpt>>hPtMD0DcaMCPSignal",cutpt&&cutPPMb&&cutmcSignal&&cutPrompt);
  tMCP->Draw("DsvpvDistance*sin(Dalpha):Dmass:Dpt>>hPtMD0DcaMCPSwapped",cutpt&&cutPPMb&&cutmcSwapped&&cutPrompt);
