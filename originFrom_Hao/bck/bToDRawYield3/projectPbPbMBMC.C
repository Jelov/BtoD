void projectPbPbMBMC()
{
	...
	TCut cutCentralityBin0to10 = "hiBin>=0&&hiBin<20";
	TCut cutCentralityBin10to30 = "hiBin>=20&&hiBin<60";
	TCut cutCentralityBin30to50 = "hiBin>=60&&hiBin<100";
	TCut cutCentralityBin50to100 = "hiBin>=100&&hiBin<200";
