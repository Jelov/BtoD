void projectPbPbMBMC()
{
  ...
  TH3D* hMCPSignal = new TH3D("hMCPSignal",";p_{T} (GeV/c);D^{0} DCA (cm);D^{0} DCA_2d (cm)",nBinX,binsX,nBinY,binsY,nBinY,binsY);
  TH3D* hMCNPSignal = new TH3D("hMCNPSignal",";p_{T} (GeV/c);D^{0} DCA (cm);D^{0} DCA_2d (cm)",nBinX,binsX,nBinY,binsY,nBinY,binsY);
  ...
  tMCP->Draw(" (TMath::Sqrt(TMath::Power(DvtxX-PVx,2)+TMath::Power(DvtxY-PVy,2))* TMath::Sin( TMath::ACos( (TMath::Power((Dpt*TMath::Cos(Dphi)+(DvtxX-PVx)),2)+TMath::Power((Dpt*TMath::Sin(Dphi)+(DvtxY-PVy)),2)- TMath::Power(Dpt*TMath::Cos(Dphi),2)-TMath::Power(Dpt*TMath::Sin(Dphi),2)- TMath::Power(DvtxX-PVx,2) -TMath::Power(DvtxY-PVy,2)) / (2* TMath::Sqrt( TMath::Power(Dpt*TMath::Cos(Dphi),2)+TMath::Power(Dpt*TMath::Sin(Dphi),2))* TMath::Sqrt( TMath::Power(DvtxX-PVx ,2)+TMath::Power(DvtxY-PVy ,2) ) ) )) ) :DsvpvDistance*sin(Dalpha):Dpt>>hMCPSignal",weightfunctionreco*(cutpt&&cutPbPbMB&&cutSignal&&cutmc&&cutPrompt));
  tMCNP->Draw("(TMath::Sqrt(TMath::Power(DvtxX-PVx,2)+TMath::Power(DvtxY-PVy,2))* TMath::Sin( TMath::ACos( (TMath::Power((Dpt*TMath::Cos(Dphi)+(DvtxX-PVx)),2)+TMath::Power((Dpt*TMath::Sin(Dphi)+(DvtxY-PVy)),2)- TMath::Power(Dpt*TMath::Cos(Dphi),2)-TMath::Power(Dpt*TMath::Sin(Dphi),2)- TMath::Power(DvtxX-PVx,2) -TMath::Power(DvtxY-PVy,2)) / (2* TMath::Sqrt( TMath::Power(Dpt*TMath::Cos(Dphi),2)+TMath::Power(Dpt*TMath::Sin(Dphi),2))* TMath::Sqrt( TMath::Power(DvtxX-PVx ,2)+TMath::Power(DvtxY-PVy ,2) ) ) )) ):DsvpvDistance*sin(Dalpha):Dpt>>hMCNPSignal",weightfunctionreco*(cutpt&&cutPbPbMB&&cutSignal&&cutmc&&cutNonPrompt));
  tMCP->Draw("DsvpvDistance*sin(Dalpha):Dmass:Dpt>>hPtMD0DcaMCPSignal",cutpt&&cutPbPbMB&&cutmcSignal&&cutPrompt);
  tMCP->Draw("DsvpvDistance*sin(Dalpha):Dmass:Dpt>>hPtMD0DcaMCPSwapped",cutpt&&cutPbPbMB&&cutmcSwapped&&cutPrompt);
 

	TH1D* hMCPSignal_DCA2d = new TH1D("hMCPSignal_DCA2d","hMCPSignal_DCA2d",nBinY,binsY);
	hMCPSignal_DCA2d->Sumw2();
	tMCP->Draw("(TMath::Sqrt(TMath::Power(DvtxX-PVx,2)+TMath::Power(DvtxY-PVy,2))* TMath::Sin( TMath::ACos( (TMath::Power((Dpt*TMath::Cos(Dphi)+(DvtxX-PVx)),2)+TMath::Power((Dpt*TMath::Sin(Dphi)+(DvtxY-PVy)),2)- TMath::Power(Dpt*TMath::Cos(Dphi),2)-TMath::Power(Dpt*TMath::Sin(Dphi),2)- TMath::Power(DvtxX-PVx,2) -TMath::Power(DvtxY-PVy,2)) / (2* TMath::Sqrt( TMath::Power(Dpt*TMath::Cos(Dphi),2)+TMath::Power(Dpt*TMath::Sin(Dphi),2))* TMath::Sqrt( TMath::Power(DvtxX-PVx ,2)+TMath::Power(DvtxY-PVy ,2) ) ) )) )>>hMCPSignal_DCA2d",weightfunctionreco*(cutpt&&cutPbPbMB&&cutSignal&&cutmc&&cutPrompt));
