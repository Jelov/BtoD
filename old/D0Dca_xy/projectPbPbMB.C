void projectPbPbMB()
{
  ...
  tData->Draw("(TMath::Sqrt(TMath::Power(DvtxX-PVx,2)+TMath::Power(DvtxY-PVy,2))* TMath::Sin( TMath::ACos( (TMath::Power((Dpt*TMath::Cos(Dphi)+(DvtxX-PVx)),2)+TMath::Power((Dpt*TMath::Sin(Dphi)+(DvtxY-PVy)),2)- TMath::Power(Dpt*TMath::Cos(Dphi),2)-TMath::Power(Dpt*TMath::Sin(Dphi),2)- TMath::Power(DvtxX-PVx,2) -TMath::Power(DvtxY-PVy,2)) / (2* TMath::Sqrt( TMath::Power(Dpt*TMath::Cos(Dphi),2)+TMath::Power(Dpt*TMath::Sin(Dphi),2))* TMath::Sqrt( TMath::Power(DvtxX-PVx ,2)+TMath::Power(DvtxY-PVy ,2) ) ) )) ):DsvpvDistance*sin(Dalpha):Dpt>>hData",cutpt&&cutTriggerPbPbMB&&cutPbPbMB&&cutCentralityBin&&cutSignal);
