...
// read fine bin for extract MC shape
//	TFile*

	TCanvas *c_funfit = new TCanvas("c_funfit","c_funfit",800,800);
...
/// clone un-widthnorm to perform fit		

			TH1D* hD0DcaDataFit_fun= (TH1D*)hD0DcaDataFit->Clone("hD0DcaDataFit_fun");
			TH1D* hD0DcaMCPSignal_fun = (TH1D*)hD0DcaMCPSignal->Clone("hD0DcaMCPSignal_fun");
      TH1D* hD0DcaMCNPSignal_fun = (TH1D*)hD0DcaMCNPSignal->Clone("hD0DcaMCPSignal_fun");

/// end of clone un-widthnorm fit

      // MC Prompt D0DCA_xy fit
...
////////////////////////////
      ...
      hD0DcaMCNPSignal->GetYaxis()->SetTitle("dN / d(D^{0} DCA_xy) (cm^{-1})");
      hD0DcaMCNPSignal->GetXaxis()->SetTitle("D^{0} DCA_xy(cm)");
