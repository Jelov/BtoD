...
*/
  ...
  tData->Draw("DsvpvDistance/DsvpvDisErr:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hSideband",cutpt&&cutTriggerPbPb&&cutPbPb&&cutCentralityBin&&cutSideband);
  tData->Draw("DsvpvDistance/DsvpvDisErr:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hData",cutpt&&cutTriggerPbPb&&cutPbPb&&cutCentralityBin&&cutSignal);
