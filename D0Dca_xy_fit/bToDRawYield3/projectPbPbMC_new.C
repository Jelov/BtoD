...
//  TFile* outf = new TFile("bFeedDownPbPbMC_funfit.hist.root","recreate");
  TFile* outf = new TFile("bFeedDownPbPbMC_new.hist.root","recreate");
  ...
  TCut cutpt = "Dpt>20 && DgencollisionId==0";
  ...
  TCut weightfunctionreco = "1*(pthat>1.2*(Dpt-20))";
...
*/
  ...
  TH3D* hMCPSignal = new TH3D("hMCPSignal",";p_{T} (GeV/c);D^{0} DCA_xy (cm);flight distance significance",nBinX,binsX,nBinY,binsY,nBinZ,binsZ);
  TH3D* hMCNPSignal = new TH3D("hMCNPSignal",";p_{T} (GeV/c);D^{0} DCA_xy (cm);flight distance significance",nBinX,binsX,nBinY,binsY,nBinZ,binsZ);
  ...
  TH3D* hMCPSignal_noW = new TH3D("hMCPSignal_noW",";p_{T} (GeV/c);D^{0} DCA_xy (cm);flight distance significance",nBinX,binsX,nBinY,binsY,nBinZ,binsZ);
  TH3D* hMCNPSignal_noW = new TH3D("hMCNPSignal_noW",";p_{T} (GeV/c);D^{0} DCA_xy (cm);flight distance significance",nBinX,binsX,nBinY,binsY,nBinZ,binsZ);
  ...
  tMCP->Draw("DsvpvDistance/DsvpvDisErr:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hMCPSignal",weightfunctionreco*(cutpt&&cutPbPb&&cutSignal&&cutmc&&cutPrompt&&cutmcSignal));
  tMCNP->Draw("DsvpvDistance/DsvpvDisErr:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hMCNPSignal",weightfunctionreco*(cutpt&&cutPbPb&&cutSignal&&cutmc&&cutNonPrompt&&cutmcSignal));
  tMCP->Draw("DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dmass:Dpt>>hPtMD0DcaMCPSignal",cutpt&&cutPbPb&&cutmcSignal&&cutPrompt);
  tMCP->Draw("DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dmass:Dpt>>hPtMD0DcaMCPSwapped",cutpt&&cutPbPb&&cutmcSwapped&&cutPrompt);

  tMCP->Draw("(DvtxX*sin(Dphi)-DvtxY*cos(Dphi))/DsvpvDisErr_2D:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hMCPSignal_noW",cutpt&&cutPbPb&&cutSignal&&cutmc&&cutPrompt&&cutmcSignal);
  tMCNP->Draw("(DvtxX*sin(Dphi)-DvtxY*cos(Dphi))/DsvpvDisErr_2D:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hMCNPSignal_noW",cutpt&&cutPbPb&&cutSignal&&cutmc&&cutNonPrompt&&cutmcSignal);
