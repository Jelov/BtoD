...
//  TFile* outf = new TFile("bFeedDownPbPbMBMC_funfit.hist.root","recreate");
  TFile* outf = new TFile("bFeedDownPbPbMBMC_new.hist.root","recreate");
...
*/
  ...
  tMCP->Draw("DsvpvDistance/DsvpvDisErr:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hMCPSignal",weightfunctionreco*(cutpt&&cutPbPbMB&&cutSignal&&cutmc&&cutPrompt&&cutmcSignal));
  tMCNP->Draw("DsvpvDistance/DsvpvDisErr:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hMCNPSignal",weightfunctionreco*(cutpt&&cutPbPbMB&&cutSignal&&cutmc&&cutNonPrompt&&cutmcSignal));
  ...
  tMCP->Draw("(DvtxX*sin(Dphi)-DvtxY*cos(Dphi))/DsvpvDisErr_2D:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hMCPSignal_noW",cutpt&&cutPbPbMB&&cutSignal&&cutmc&&cutPrompt&&cutmcSignal);
  tMCNP->Draw("(DvtxX*sin(Dphi)-DvtxY*cos(Dphi))/DsvpvDisErr_2D:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hMCNPSignal_noW",cutpt&&cutPbPbMB&&cutSignal&&cutmc&&cutNonPrompt&&cutmcSignal);
