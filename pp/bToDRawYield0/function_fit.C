...
void SetHistStyle(TH1* h,int color = 1, int markerstyle =24, int linestyle=1){
...
//	TFile* fPPMC = new TFile("bFeedDownPPMC_funfit.hist.root");
//	TFile* fPPMBMC = new TFile("bFeedDownPPMBMC_funfit.hist.root");
...
*/
  ...
  c_dataAll->SaveAs(Form("plots_functionfit/fitppdataAll.pdf"));
