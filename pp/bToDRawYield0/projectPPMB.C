...
*/
  ...
  tData->Draw("DsvpvDistance/DsvpvDisErr:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hSideband",cutpt&&cutTriggerPPMB&&cutPPMb&&cutSideband);
  tData->Draw("DsvpvDistance/DsvpvDisErr:DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dpt>>hData",cutpt&&cutTriggerPPMB&&cutPPMb&&cutSignal);
  tData->Draw("DvtxX*sin(Dphi)-DvtxY*cos(Dphi):Dmass:Dpt>>hPtMD0Dca",cutpt&&cutTriggerPPMB&&cutPPMb);
