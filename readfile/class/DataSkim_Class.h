...
// Sat Aug  6 03:36:58 2016 by ROOT version 6.02/13
// from TTree ntSkim/
...
#ifndef DataSkim_Class_h
#define DataSkim_Class_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   DataSkim_Class(TTree *tree=0);
   virtual ~DataSkim_Class();
...
#ifdef DataSkim_Class_cxx
DataSkim_Class::DataSkim_Class(TTree *tree) : fChain(0) 
{
...
DataSkim_Class::~DataSkim_Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DataSkim_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DataSkim_Class::LoadTree(Long64_t entry)
{
...
void DataSkim_Class::Init(TTree *tree)
{
...
void DataSkim_Class::Show(Long64_t entry)
{
...
Int_t DataSkim_Class::Cut(Long64_t entry)
{
...
#endif // #ifdef DataSkim_Class_cxx
