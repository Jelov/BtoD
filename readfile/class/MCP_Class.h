...
// Thu Jul 28 00:48:38 2016 by ROOT version 6.02/13
// from TTree ntDkpi/
...
#ifdef MCP_Class_cxx
MCP_Class::MCP_Class(TTree *tree) : fChain(0) 
{
...
Int_t MCP_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCP_Class::LoadTree(Long64_t entry)
{
...
void MCP_Class::Init(TTree *tree)
{
...
void MCP_Class::Show(Long64_t entry)
{
...
Int_t MCP_Class::Cut(Long64_t entry)
{
