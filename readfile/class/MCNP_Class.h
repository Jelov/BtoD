...
// Thu Jul 28 20:10:38 2016 by ROOT version 6.02/13
// from TTree ntDkpi/
// found on file: /data/HeavyFlavourRun2/MC2015/Dntuple/PbPb/ntD_EvtBase_20160513_DfinderMC_PbPb_20160502_dPt1tkPt0p5_D0_nonprompt_Dpt2Dy1p1tkPt0p7tkEta2Decay2p9Dalpha0p14Skim_pthatweight.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         BSWidthY;
   Float_t         BSWidthYErr;
   Int_t           Dindex[71];   //[Dsize]
   Int_t           Dtype[71];   //[Dsize]
   Float_t         Dmass[71];   //[Dsize]
   Float_t         Dpt[71];   //[Dsize]
   Float_t         Deta[71];   //[Dsize]
   Float_t         Dphi[71];   //[Dsize]
   Float_t         Dy[71];   //[Dsize]
   Float_t         DvtxX[71];   //[Dsize]
   Float_t         DvtxY[71];   //[Dsize]
   Float_t         Dd0[71];   //[Dsize]
   Float_t         Dd0Err[71];   //[Dsize]
   Float_t         Ddxyz[71];   //[Dsize]
   Float_t         DdxyzErr[71];   //[Dsize]
   Float_t         Dchi2ndf[71];   //[Dsize]
   Float_t         Dchi2cl[71];   //[Dsize]
   Float_t         Ddtheta[71];   //[Dsize]
   Float_t         Dlxy[71];   //[Dsize]
   Float_t         Dalpha[71];   //[Dsize]
   Float_t         DsvpvDistance[71];   //[Dsize]
   Float_t         DsvpvDisErr[71];   //[Dsize]
   Float_t         DsvpvDistance_2D[71];   //[Dsize]
   Float_t         DsvpvDisErr_2D[71];   //[Dsize]
   Float_t         DtktkRes_chi2ndf[71];   //[Dsize]
   Float_t         DtktkRes_chi2cl[71];   //[Dsize]
   Float_t         DtktkRes_alpha[71];   //[Dsize]
   Float_t         DtktkRes_svpvDistance[71];   //[Dsize]
   Float_t         DtktkRes_svpvDisErr[71];   //[Dsize]
   Float_t         DlxyBS[71];   //[Dsize]
   Float_t         DlxyBSErr[71];   //[Dsize]
   Float_t         DMaxDoca[71];   //[Dsize]
   Float_t         Dtrk1Pt[71];   //[Dsize]
   Float_t         Dtrk2Pt[71];   //[Dsize]
   Float_t         Dtrk1Eta[71];   //[Dsize]
   Float_t         Dtrk2Eta[71];   //[Dsize]
   Float_t         Dtrk1Phi[71];   //[Dsize]
   Float_t         Dtrk2Phi[71];   //[Dsize]
   Float_t         Dtrk1PtErr[71];   //[Dsize]
   Float_t         Dtrk2PtErr[71];   //[Dsize]
   Float_t         Dtrk1Dxy[71];   //[Dsize]
   Float_t         Dtrk2Dxy[71];   //[Dsize]
   Float_t         Dtrk1PixelHit[71];   //[Dsize]
   Float_t         Dtrk2PixelHit[71];   //[Dsize]
   Float_t         Dtrk1StripHit[71];   //[Dsize]
   Float_t         Dtrk2StripHit[71];   //[Dsize]
   Float_t         Dtrk1nStripLayer[71];   //[Dsize]
   Float_t         Dtrk2nStripLayer[71];   //[Dsize]
   Float_t         Dtrk1nPixelLayer[71];   //[Dsize]
   Float_t         Dtrk2nPixelLayer[71];   //[Dsize]
   Float_t         Dtrk1Chi2ndf[71];   //[Dsize]
   Float_t         Dtrk2Chi2ndf[71];   //[Dsize]
   Float_t         Dtrk1MassHypo[71];   //[Dsize]
   Float_t         Dtrk2MassHypo[71];   //[Dsize]
   Int_t           Dtrk1Algo[71];   //[Dsize]
   Int_t           Dtrk2Algo[71];   //[Dsize]
   Int_t           Dtrk1originalAlgo[71];   //[Dsize]
   Int_t           Dtrk2originalAlgo[71];   //[Dsize]
   Bool_t          Dtrk1highPurity[71];   //[Dsize]
   Bool_t          Dtrk2highPurity[71];   //[Dsize]
   Int_t           Dtrk1Idx[71];   //[Dsize]
   Int_t           Dtrk2Idx[71];   //[Dsize]
   Float_t         Dtrk1EtaErr[71];   //[Dsize]
   Float_t         Dtrk2EtaErr[71];   //[Dsize]
   Float_t         Dtrk1PhiErr[71];   //[Dsize]
   Float_t         Dtrk2PhiErr[71];   //[Dsize]
   Float_t         Dtrk1Y[71];   //[Dsize]
   Float_t         Dtrk2Y[71];   //[Dsize]
   Float_t         Dtrk1D0Err[71];   //[Dsize]
   Float_t         Dtrk2D0Err[71];   //[Dsize]
   Float_t         Dtrk1MVAVal[71];   //[Dsize]
   Float_t         Dtrk2MVAVal[71];   //[Dsize]
   Int_t           Dtrk1Quality[71];   //[Dsize]
   Int_t           Dtrk2Quality[71];   //[Dsize]
   Float_t         Dgen[71];   //[Dsize]
   Int_t           DgenIndex[71];   //[Dsize]
   Int_t           DgennDa[71];   //[Dsize]
   Float_t         Dgenpt[71];   //[Dsize]
   Float_t         Dgeneta[71];   //[Dsize]
   Float_t         Dgenphi[71];   //[Dsize]
   Float_t         Dgeny[71];   //[Dsize]
   Int_t           DgencollisionId[71];   //[Dsize]
   Float_t         DgenBAncestorpt[71];   //[Dsize]
   Int_t           DgenBAncestorpdgId[71];   //[Dsize]
...
#ifdef MCNP_Class_cxx
MCNP_Class::MCNP_Class(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/HeavyFlavourRun2/MC2015/Dntuple/PbPb/ntD_EvtBase_20160513_DfinderMC_PbPb_20160502_dPt1tkPt0p5_D0_nonprompt_Dpt2Dy1p1tkPt0p7tkEta2Decay2p9Dalpha0p14Skim_pthatweight.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/HeavyFlavourRun2/MC2015/Dntuple/PbPb/ntD_EvtBase_20160513_DfinderMC_PbPb_20160502_dPt1tkPt0p5_D0_nonprompt_Dpt2Dy1p1tkPt0p7tkEta2Decay2p9Dalpha0p14Skim_pthatweight.root");
      }
...
MCNP_Class::~MCNP_Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCNP_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCNP_Class::LoadTree(Long64_t entry)
{
...
void MCNP_Class::Init(TTree *tree)
{
...
void MCNP_Class::Show(Long64_t entry)
{
...
Int_t MCNP_Class::Cut(Long64_t entry)
{
