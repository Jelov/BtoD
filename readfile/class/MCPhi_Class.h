...
// Thu Jul 28 00:49:20 2016 by ROOT version 6.02/13
// from TTree ntHi/
...
#ifndef MCPhi_Class_h
#define MCPhi_Class_h
...
#ifdef MCPhi_Class_cxx
MCPhi_Class::MCPhi_Class(TTree *tree) : fChain(0) 
{
...
MCPhi_Class::~MCPhi_Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCPhi_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCPhi_Class::LoadTree(Long64_t entry)
{
...
void MCPhi_Class::Init(TTree *tree)
{
...
void MCPhi_Class::Show(Long64_t entry)
{
...
Int_t MCPhi_Class::Cut(Long64_t entry)
{
