...
// Sat Aug  6 03:38:54 2016 by ROOT version 6.02/13
// from TTree ntHi/
...
#ifndef MBDataHi_Class_h
#define MBDataHi_Class_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   MBDataHi_Class(TTree *tree=0);
   virtual ~MBDataHi_Class();
...
#ifdef MBDataHi_Class_cxx
MBDataHi_Class::MBDataHi_Class(TTree *tree) : fChain(0) 
{
...
MBDataHi_Class::~MBDataHi_Class()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MBDataHi_Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MBDataHi_Class::LoadTree(Long64_t entry)
{
...
void MBDataHi_Class::Init(TTree *tree)
{
...
void MBDataHi_Class::Show(Long64_t entry)
{
...
Int_t MBDataHi_Class::Cut(Long64_t entry)
{
...
#endif // #ifdef MBDataHi_Class_cxx
